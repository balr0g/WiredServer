...
for i in "banlist" "banner.png" "board/General/.wired/permissions" "board/General/BC5B30BF-AC4F-4FEE-BB92-C5F3A5436E18.WiredThread/AD70D7CB-F789-4030-A92F-40D546DBE1D9.WiredPost" "files/Drop Box/.wired/type" "files/Uploads/.wired/type" "groups" "news" "users" "wired.xml"; do
